...
vi.mock('socket.io-client', () => {
  ...
  return {
    ...
    // Expose getter to access mock
    __getMockSocket: () => mockSocketInstance
  };
});
...
describe('KanbanBoard Integration Tests - Comprehensive', () => {
  ...
  beforeEach(() => {
    // Get the mock socket reference
    const socketModule = require('socket.io-client');
    mockSocket = socketModule.__getMockSocket();

    // Reset socket state and spies
